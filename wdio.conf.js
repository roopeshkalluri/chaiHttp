...
exports.config = {
    ...
    ['junit', {
        ...
        outputFileFormat: function (options) { // optional
            return `TEST-${options.cid}.${options.capabilities.browserName}.xml`
        }
    }]],
    ...
    //  fsExtra.emptyDirSync('./imageComparision/actual');
    //  fsExtra.emptyDirSync('./imageComparision/toBeCompared');
    //  fsExtra.emptyDirSync('./imageComparision/difference');
